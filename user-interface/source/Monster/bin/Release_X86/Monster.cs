...
namespace MonsterApplication
{
    ...
    public partial class TelaBusca : Form
    {
        ...
        double[,] valor_calibrado = new double[1, 4];
        double[,] media_amostras = new double[1, 4]; //integral das amostras
        ...
        public int periodo_descoberta = 300000; //300k ms = 5m
        ...
        private void listaGravacao_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            { //Value is null }
                multiplicador_gravacao = 5; //300k ms = 5 min
                Console.WriteLine("ComboBox Gravacao");
                Console.WriteLine(multiplicador_gravacao.ToString());
            }
        }
                ...
                if (serialMestre.IsOpen == true)
                {
                    if (serialMestre.BytesToRead > 0)
                    {
                        ...
                        if (rx_counter > 0)
                        {
                            ...
                            if (rx_counter == 28) //tamanho do frame de retorno do IO Data Sample RX Indicator
                            {
                ...
                if (serialMestre.IsOpen == true)
                {
                    if (serialMestre.BytesToRead > 0)
                    {
                        ...
                        if (rx_counter > 0)
                        {
                            ...
                            if (rx_counter == 28) //tamanho do frame de retorno do ATND
                            {
        ...
        private void timer_gravacao_Tick(Object myObject, EventArgs myEventArgs)
        {
            ...
            if (multiplicador_local == multiplicador_gravacao)
            {
                ...
                ulong contador_local = contador_amostras_validas;
                ...
                if (contador_local > 0)
                {
                    ...
                    log_arquivo.WriteLine(DateTime.Now.ToString("dd/MM/yyyy") + separador + DateTime.Now.ToString("HH:mm:ss") + separador + indice_gravacao + separador +
                        media_amostras[0, 0].ToString() + separador + media_amostras[0, 1].ToString() + separador + media_amostras[0, 2].ToString() + separador + media_amostras[0, 3].ToString());
